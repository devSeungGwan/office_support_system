...
# 조사할 디렉토리 경로
ROOT_DIR = 'C:/Users/Yoo/AppData/Local/Programs/Python/Python37-32/Lib/site-packages/PyQt5/uic/OSS'
...
print(f'\n전체 파일 수: {total_file_count} 개')
print(f'전체 코드 라인 수: {total_line_count} 줄\n')